...
pub trait Key {
    /// Try extract this key type from the type-erased JWK
    fn from(jwk: &Specified) -> Result<&Self, Error>;
}
...
impl AlgorithmParameters {
    ...
    // /// let jwk: no_way::jwk::JWK<no_way::()> = serde_json::from_str(
    // /// r#"{
    // ///   "kty": "RSA",
    ...
    // /// ).unwrap();
    // /// assert_eq!(
    // ///   jwk.algorithm.thumbprint(&no_way::digest::SHA256).unwrap(),
...
impl OctetKey {
    /// Create a new octet key from these bytes
    ...
    /// Get a byte slice from this octet key
...
impl Specified {
    ...
    /// Adds additional headers to this JWK
...
mod tests {
    ...
    mod key_operations_serde_token {
        use super::*;
        #[derive(Debug, Eq, PartialEq, Serialize, Deserialize)]
        struct Test {
            test: KeyOperations,
                ...
                JWK {
                    specified: Specified {
                        ...
                        algorithm: AlgorithmParameters::RSA(RSAKeyParameters {
                            ...
                            e: BigUint::from_chunks(vec![65537]),
                            d: Some(BigUint::from_chunks(vec![
                            ...
                            p: Some(BigUint::from_chunks(vec![
                            ...
                            q: Some(BigUint::from_chunks(vec![
                            ...
                            dp: Some(BigUint::from_chunks(vec![
                            ...
                            dq: Some(BigUint::from_chunks(vec![
                            ...
                            qi: Some(BigUint::from_chunks(vec![
